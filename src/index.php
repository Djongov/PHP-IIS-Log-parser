...
<div class="max-w-xl mx-auto" id="drop-area">
    ...
    <p class="my-4 text-center">Only shows http statuses > 400 (failed requests)</p>
    ...
    <label
        ...
        <span class="flex items-center space-x-2">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-gray-600 dark:text-gray-400" fill="none" viewBox="0 0 24 24"
